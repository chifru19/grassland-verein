...
export default function App() {
  ...
  // This function makes the menu items clickable and scrolls to the sections
  const scrollTo = (id) => {
    const element = document.getElementById(id);
    if (element) {
      const yOffset = -80; // Space for the sticky navbar
    ...
    <div className="App" style={{ backgroundColor: '#fdfbf7', color: '#2c3e50', minHeight: '100vh', fontFamily: 'Segoe UI, Tahoma, sans-serif' }}>
      ...
      <header id="home" style={{ backgroundColor: '#fff', padding: '60px 20px', textAlign: 'center', borderBottom: '6px solid #1b5e20' }}>
        <div style={{ marginBottom: '20px' }}>
          {/* UPDATED TO CAPITAL 'L' TO MATCH YOUR SIDEBAR */}
          <img 
            src="/images/Logo.png" 
            ...
            onError={(e) => { e.target.src = "https://via.placeholder.com/200?text=Logo+Case+Error"; }}
          />
        </div>
      ...
      <main style={{ maxWidth: '1100px', margin: '0 auto', padding: '40px 20px' }}>
        ...
        <section id="meetings" style={{ marginBottom: '100px', scrollMarginTop: '100px' }}>
          ...
          <div style={{ background: '#fff', padding: '40px', borderRadius: '20px', boxShadow: '0 5px 20px rgba(0,0,0,0.05)', marginTop: '20px' }}>
            ...
            <p style={{ fontSize: '1.2rem', lineHeight: '1.6' }}>
              Our monthly gatherings take place at our Berlin center for community dialogue and heritage preservation.
            </p>
        ...
        <section id="ngoteh" style={{ marginBottom: '100px', scrollMarginTop: '100px' }}>
          ...
          <div style={{ background: '#fff', padding: '30px', borderRadius: '15px', marginTop: '20px', boxShadow: '0 4px 10px rgba(0,0,0,0.05)' }}>
            <p>Preserving Grassland heritage through drumming, traditional dance, and storytelling.</p>
          </div>
        </section>
        ...
        <section id="kids" style={{ marginBottom: '100px', scrollMarginTop: '100px', backgroundColor: '#fffbe6', padding: '50px', borderRadius: '30px' }}>
          ...
          <p style={{ textAlign: 'center', fontSize: '1.2rem' }}>Cultural workshops and fables for the next generation.</p>
        </section>
      ...
      <footer style={{ textAlign: 'center', padding: '60px', borderTop: '1px solid #ddd' }}>
        <p>© 2026 Grassland Kulturverein e.V. Berlin | Managed by Frank Fru</p>
      </footer>
    </div>
  );
}