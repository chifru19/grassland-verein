 ...
 * Version: 5.1.0
 * Features:
 * - Trilingual (EN/DE/FR) translation system
 * - Dynamic galleries with path resolution for GitHub Pages
 * - Video & Image integration for all sections
 */
...
const i18n = {
  ...
  de: {
    ...
    meetingSub: "Jeden zweiten Samstag",
    meetingDesc: "Besuchen Sie uns in der Sprengelstr. 15, 13353 Berlin.",
    kidsTitle: "Kinder- und Jugendbereich",
    kidsDesc: "Bewahrung unseres Erbes durch Sprache und Tanz.",
    eventsTitle: "Kommende Veranstaltungen",
    eventsDesc: "Erfahren Sie mehr über unsere nächsten Termine.",
  ...
  fr: {
    ...
    meetingSub: "Chaque deuxième samedi",
    meetingDesc: "Rejoignez-nous au 15, Sprengelstr., 13353 Berlin.",
    kidsTitle: "Section Enfants et Jeunes",
    kidsDesc: "Préserver notre héritage par la langue et la danse.",
...
export default function App() {
  ...
  // Helper: Ensures files load correctly on GitHub Pages
  const p = (path) => `${process.env.PUBLIC_URL}${path}`;

  // --- 2. DATA REPOSITORIES (Renamed to match render logic exactly) ---
  const mainGallery = [
    ...
    <div style={{ backgroundColor: '#fdfbf7', minHeight: '100vh', paddingBottom: '50px', fontFamily: 'Segoe UI' }}>
      ...
      <main>
        ...
        <section id="gallery" style={styles.section}>
          ...
          <div style={styles.grid}>{mainGallery.map((src, i) => <div key={i} style={styles.card}><img src={src} style={{ width: '100%', height: '280px', objectFit: 'cover' }} alt="Gallery" /></div>)}</div>
        </section>
