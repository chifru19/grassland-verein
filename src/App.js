  ...
  return (
    <div className="App" style={{ backgroundColor: '#fdfbf7', color: '#2c3e50', minHeight: '100vh', fontFamily: 'Segoe UI, sans-serif' }}>
      ...
      <main style={{ maxWidth: '1200px', margin: '0 auto', padding: '60px 20px' }}>
        ...
        {/* --- NGOTEH SECTION: LEADERSHIP & GALLERY --- */}
        ...
        <section id="activities" style={{ marginBottom: '120px', scrollMarginTop: '100px' }}>
          <h2 style={sectionHeaderStyle}>Upcoming Events & Activities</h2>
        ...
        <section id="kids" style={{ marginBottom: '120px', scrollMarginTop: '100px', backgroundColor: '#fffbe6', padding: '60px', borderRadius: '40px' }}>
          ...
          <p style={{ textAlign: 'center', fontSize: '1.3rem' }}>Passing down storytelling and language to the next generation.</p>
        </section>
        ...
        <section id="support" style={{ marginBottom: '120px', scrollMarginTop: '100px', backgroundColor: '#1b5e20', color: 'white', padding: '80px 20px', borderRadius: '40px', textAlign: 'center' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '30px' }}>
            <div style={{ backgroundColor: 'white', padding: '20px', borderRadius: '20px' }}>
              <img src="/images/qr-code.png" alt="Donate QR" style={{ width: '220px', height: '220px' }} />
        ...
        <section style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(400px, 1fr))', gap: '50px', marginTop: '40px' }}>
          <div style={{ backgroundColor: '#fff', padding: '50px', borderRadius: '25px', boxShadow: '0 10px 30px rgba(0,0,0,0.05)' }}>
            ...
            <form onSubmit={handleRegister} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
              ...
              <button type="submit" style={{ backgroundColor: '#f9a825', color: '#1b5e20', padding: '18px', fontWeight: '800', border: 'none', borderRadius: '10px', cursor: 'pointer' }}>Submit Registration</button>
            </form>
          </div>
          <div style={{ padding: '20px' }}>
            ...
            <a href="https://frankfru.com" target="_blank" rel="noreferrer" style={{ color: '#1b5e20', textDecoration: 'none', fontWeight: '800', fontSize: '1.2rem', borderBottom: '2px solid #f9a825' }}>frankfru.com</a>
          </div>
        </section>
      </main>

      <footer style={{ textAlign: 'center', padding: '80px 20px', borderTop: '1px solid #eee', marginTop: '60px' }}>
