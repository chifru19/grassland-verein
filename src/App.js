      ...
      <main style={{ maxWidth: '1100px', margin: '0 auto', padding: '60px 20px' }}>
        ...
        <section id="meetings" style={{ marginBottom: '100px', scrollMarginTop: '100px' }}>
          ...
          <div style={{ background: '#fff', padding: '40px', borderRadius: '20px', boxShadow: '0 5px 20px rgba(0,0,0,0.05)', border: '1px solid #eee' }}>
            ...
            <p style={{ fontSize: '1.2rem', lineHeight: '1.6' }}>Join us for community dialogue at Sprengelstr. 15, 13353 Berlin.</p>
          </div>
        </section>
        ...
        <section id="support" style={{ marginBottom: '100px', scrollMarginTop: '100px', backgroundColor: '#1b5e20', color: 'white', padding: '60px', borderRadius: '40px', textAlign: 'center' }}>
          <h2 style={{ color: '#f9a825', fontSize: '2.8rem', marginBottom: '30px' }}>Support Our Mission</h2>
          <div style={{ backgroundColor: 'white', display: 'inline-block', padding: '20px', borderRadius: '20px', marginBottom: '30px' }}>
            <img src="/images/qr-code.png" alt="Donate" style={{ width: '220px', height: '220px' }} />
          </div>
          <div style={{ fontSize: '1.4rem' }}>
            <p><strong>BERLINER VOLKSBANK</strong></p>
        ...
        <section style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', gap: '50px' }}>
          ...
          <div style={{ padding: '20px' }}>
            ...
            <a href="https://frankfru.com" target="_blank" rel="noreferrer" style={{ color: '#1b5e20', fontWeight: '800' }}>frankfru.com</a>
          </div>
        </section>
      </main>
