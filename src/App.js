 ...
 * Full Production Version - 12 Videos, Flyer Preview, Ngoteh, and Credits
 */
      ...
      <main style={{ maxWidth: '1200px', margin: '0 auto', padding: '40px 20px' }}>
        ...
        <section id="meetings" style={{ marginBottom: '80px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '20px' }}>
            {meetingGalleryImages.map((src, i) => <img key={i} src={getPath(src)} alt="Meeting" style={{ width: '100%', borderRadius: '20px', height: '220px', objectFit: 'cover' }} className="hover-card" />)}
          </div>
        </section>
        ...
        <section id="events" style={{ marginBottom: '80px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '30px', background: '#fff', padding: '30px', borderRadius: '25px', border: '1px solid #eee' }}>
            ...
            <a href={getPath('assets/event-flyer.pdf')} download style={{ textDecoration: 'none' }}>
                <img src={getPath('images/flyer-preview.jpg')} alt="Flyer Preview" style={{ width: '100%', borderRadius: '15px' }} />
            </a>
          </div>
        </section>
        ...
        <section id="kids" style={{ marginBottom: '80px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '20px' }}>
            {kidsVideos.map((src, i) => <video key={i} src={getPath(src)} controls style={{ width: '100%', borderRadius: '10px', height: '220px' }} className="hover-card" />)}
          </div>
        </section>
        ...
        <section id="gallery" style={{ marginBottom: '80px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '20px' }}>
            {mainGalleryImages.map((src, i) => <img key={i} src={getPath(src)} alt="Gallery" style={{ width: '100%', borderRadius: '20px', height: '280px', objectFit: 'cover' }} className="hover-card" />)}
          </div>
        </section>
